...
public class SpatialHashGrid {
	...
	public void insertStaticObjects(GameObject object) {
	...
	public void removeObject(GameObject object) {
		int[] cellsIds = getCellIds(object);
		int i = 0;
		int cellId = -1;
	...
	public void clearDynamicCells(GameObject object) {
	 ...
	 public int[] getCellIds(GameObject object) {
	        int x1 = (int)Math.floor(object.bounds.lowerLeft.x / cellSize);
	        int y1 = (int)Math.floor(object.bounds.lowerLeft.y / cellSize);
	        int x2 = (int)Math.floor((object.bounds.lowerLeft.x + object.bounds.width) / cellSize);
	        int y2 = (int)Math.floor((object.bounds.lowerLeft.y + object.bounds.height) / cellSize);
